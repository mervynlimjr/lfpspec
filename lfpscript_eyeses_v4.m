...
%v4: changing the spectrogram parameters to 100,80 and changing the
%normalisation window to -200 to 200
...
%     
    ...
    for s=1:16 % limit the data from 0s to 1s only (average mean length of the trials)
    ...
    plotspec(mrawspec,0.05,0.35,1,50,-3,3);
    ...
    plotspec(mspec,0.05,0.35,1,50,-1,1);
    ...
    %power spectrum
    localpowerspectrum(mvlspec,1,50,-3,3);
