...
%v3: changing the spectrogram parameters to 100,80 and changing the
%normalisation window to 0 to 1000
...
%     
    ...
    for s=1:48 % limit the data from 0s to 1s only (average mean length of the trials)
    ...
    plotspec(mrawspec,0.05,1,1,50,-3,3);
    ...
    plotspec(mspec,0.05,1,1,50,-3,3);
    ...
    axis([1 50 -5 5]);
    set(gca,'FontSize',15); xticks(0:5:50); yticks(-5:1:5);
    ...
    plotspec(mvlspec,-0.95,7,1,50,-1,1);
    ...
    %power spectrum
    localpowerspectrum(mvlspec,1,50,-1,1);
