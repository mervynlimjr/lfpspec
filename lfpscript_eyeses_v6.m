...
%v6: changing the spectrogram parameters to 500,450 and changing the
%normalisation window to 0 to 2000

userfol="/Users/AlizarinMoon";
savefolder="/seseyev6_1/";
...
%     
    ...
    for s=1:156 % limit the data from -1.0s to 7s only (average mean length of the trials)
        Pmatrix=[];
...
Pnorm1=mean(mspec.Pnorm(:,16:36),2); % Cue-onset
Pnorm2=mean(mspec.Pnorm(:,36:56),2); % Pure movement
Pnorm3=mean(mspec.Pnorm(:,26:46),2); % Movement-onset
Pnorm4=mean(mspec.Pnorm(:,24:28),2); % Mid-cue
